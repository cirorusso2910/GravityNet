...
def detections_validation_radius(filenames: torch.Tensor,
                                 ...
                                 debug: bool):
    """
    Compute detections in validation with radius metrics and save detections.csv
