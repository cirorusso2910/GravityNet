...
def show_metrics_test_NMS(metrics: dict,
                          NMS_type: str,
                          work_point: int):
    """
    ...
    print("\n---------------------"
          "\nMETRICS TEST NMS {}:".format(NMS_type),
          "\n---------------------"
          "\nAUC: {}".format(AUC),
    ...
    print("\n-----"
          "\nTIME:"
          "\n-----"
          "\nTEST NMS: {} h {} m {} s".format(metrics_time_test_NMS['hours'], metrics_time_test_NMS['minutes'], metrics_time_test_NMS['seconds']),
